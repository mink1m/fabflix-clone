...
public class UpdateSecurePassword {
    ...
    public static void main(String[] args) throws Exception {
        ...
        encryptCustomers(statement);
        encryptEmployees(statement);
    ...
    public static void encryptCustomers(Statement statement) throws Exception {
    ...
    public static void encryptEmployees(Statement statement) throws Exception {
